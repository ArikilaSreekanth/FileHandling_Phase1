		...
		public static void handleWelcomeScreenInput() {
			...
			do {
				try {
					...
					switch (input) {
					case 1:
						Myoperations.displayAllFiles("main");
						break;
					case 2:
						MyOptions.handleFileMenuOptions();
						break;
					case 3:
			...
			do {
				try {
					...
					case 1:
						...
						Myoperations.createFile(fileToAdd, sc);
					...
					case 2:
						...
						Myoperations.createMainFolderIfNotPresent("main");
						List<String> filesToDelete = Myoperations.displayFileLocations(fileToDelete, "main");
						...
						if (idx != 0) {
							Myoperations.deleteFileRecursively(filesToDelete.get(idx - 1));
						} else {
							
							// If idx == 0, delete all files displayed for the name
							for (String path : filesToDelete) {
								Myoperations.deleteFileRecursively(path);
							}
						}
					...
					case 3:
						...
						Myoperations.createMainFolderIfNotPresent("main");
						Myoperations.displayFileLocations(fileName, "main");
